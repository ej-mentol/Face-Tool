...
namespace HammerTime.FaceTool.Operations
{
    ...
    {
        public static Matrix4x4 CreateMatrix(IEnumerable<Vector3> sourceVertices, Sledge.DataStructures.Geometric.Plane targetPlane, float offset, bool lockX, bool lockY, bool lockZ)
        {
            ...
            var closestPoint = sourceVertices
        ...
        public static Matrix4x4 CreateMatrix(Vector3 sourcePoint, Sledge.DataStructures.Geometric.Plane targetPlane, float offset, bool lockX, bool lockY, bool lockZ)
        {
            return CreateMatrix(new[] { sourcePoint }, targetPlane, offset, lockX, lockY, lockZ);
        }
